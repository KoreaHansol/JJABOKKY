<template>
  <div class="qna-container">
      <div class="contant-container">
        <img class="img-okky" src="/static/image/knowledge.JPG"/>
        <div class="content-header">
          <div class="btn-question" @click="onClickQuestion">질문하기</div>
          <div class="link-area">
            <div class="link" :class="{ 'selected': selectBoardType === 'technews' }" @click="onSelectBoardType( 'technews' )">Tech 뉴스</div>
            <div class="link" :class="{ 'selected': selectBoardType === 'tip' }" @click="onSelectBoardType( 'tip' )">팁</div>
            <div class="link" :class="{ 'selected': selectBoardType === 'column' }" @click="onSelectBoardType( 'column' )">칼럼</div>
            <div class="link" :class="{ 'selected': selectBoardType === 'review' }" @click="onSelectBoardType( 'review' )">리뷰</div>
